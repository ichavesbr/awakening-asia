    ...
    <>
      ...
      <section className="relative min-h-[70vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative text-center max-w-3xl px-6 py-20">
          ...
          <p className="text-stone-500 text-sm font-light max-w-md mx-auto leading-relaxed mb-10">
      ...
      <section className="relative h-[55vh] overflow-hidden flex items-center justify-center">
        <div className="absolute inset-0">
          <Image src="/leaders.png" alt="Leaders gathering" fill sizes="100vw" className="object-cover" />
        </div>
      ...
      <section className="py-24 vision-section">
        <div className="max-w-7xl mx-auto px-6">
          <FadeIn>
            <div className="relative border border-dark-600 bg-dark-800 px-8 py-10 md:px-14 md:py-12 text-center overflow-hidden">
              {/* Corner accents */}
              ...
              <div className="relative">
                ...
                <h2 className="font-serif text-4xl md:text-6xl text-stone-100 font-light mb-4 leading-tight">
                  Are you ready to
                  <br />
